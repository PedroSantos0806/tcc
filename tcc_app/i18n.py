...
I18N = {
    "pt": {
        ...
        "Category":"Categoria","All":"Todas","Products":"Produtos","Items":"Itens",
        "Cost value":"Valor de Custo","Sale value":"Valor de Venda",
        "Status":"Status","Sold %":"% Vendido","In stock":"Em estoque",
        "Unit cost":"Custo Unit","Unit price":"Preço Unit",
        "OK":"OK","Low":"Baixo","Days":"dias",

        "Safety Margin (%)":"Margem de Segurança (%)","Horizon (days)":"Horizonte (dias)","Recalculate":"Recalcular",
        "No suggestions now":"Sem itens sugeridos no momento.",
        "Total Items":"Total de Itens","Estimated Cost":"Custo Estimado","Margin":"Margem",
    ...
    "en": {
        ...
        "Weekly sales":"Weekly sales","Weekly revenue":"Weekly revenue",
        "Low stock items":"Low stock items","Out of stock items":"Out of stock items",

        "Welcome to PrevFood!":"Welcome to PrevFood!",
        "Start setup text":"Start by configuring your menu and ingredients to track stock and get smart predictions.",
        ...
        "Category":"Category","All":"All","Products":"Products","Items":"Items",
        "Cost value":"Cost value","Sale value":"Sale value",
        "Status":"Status","Sold %":"Sold %","In stock":"In stock",
        "Unit cost":"Unit cost","Unit price":"Unit price",
        ...
        "Total Items":"Total Items","Estimated Cost":"Estimated Cost","Margin":"Margin",
    ...
    "es": {
        ...
        "Welcome to PrevFood!":"¡Bienvenido a PrevFood!",
        "Start setup text":"Empieza configurando tu menú e ingredientes para control y predicciones.",
        ...
        "Category":"Categoría","All":"Todas","Products":"Productos","Items":"Ítems",
        "Cost value":"Valor de Costo","Sale value":"Valor de Venta",
        "Status":"Estado","Sold %":"% Vendido","In stock":"En stock",
        "Unit cost":"Costo Unit","Unit price":"Precio Unit",
        ...
        "Total Items":"Total de Ítems","Estimated Cost":"Costo Estimado","Margin":"Margen",
...
def t(key: str) -> str:
    # Normaliza para evitar problemas com espaços acidentais
